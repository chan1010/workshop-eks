---
title : "Installing Terraform and VPC Network Architecture"
date :  "`r Sys.Date()`" 
weight : 4 
chapter : false
pre : " <b> 2.4 </b> "
...
2. Installing the Terraform Networking Module from GitHub

```
git clone https://github.com/leonli/terraform-vpc-networking 
cd terraform-vpc-networking
```
Use the command below to access the **main.tf** file and change ***vpc = true*** to ***domain = "vpc"***.
```
sudo vim modules/networking/main.tf
```
![CREATENETWORKING](/images/2.prerequisite/001-installterraform.png)
3. Create the necessary parameters in terraform.tfvars to build the VPC network architecture..
...
4. Initialize the environment and apply the template to create the VPC and related resources.
...
5. Access the [VPC service management interface](https://ap-southeast-1.console.aws.amazon.com/vpc/home) to explore the created configurations.
